...
export class AboutPage {
  ...
  constructor(private callNumber: CallNumber,public loadingCtrl: LoadingController,public services:ServicesProvider,private modal: ModalController,public navCtrl: NavController,public nativeGeocoder: NativeGeocoder) {
